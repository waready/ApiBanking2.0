...
Método para modificar una condición impositiva para una persona. 

Nombre publicación | Programa | Global/País 
--------- | ----------- | ----------- 
BTContabilidad.ActualizarCondicionImpositiva | RBTPG288 | Global 

> Ejemplo de invocación al método Actualizar Condición Impositiva: 
