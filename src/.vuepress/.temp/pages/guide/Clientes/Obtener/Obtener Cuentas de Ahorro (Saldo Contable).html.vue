<template><div><h1 id="obtener-cuentas-de-ahorro-saldo-contable" tabindex="-1"><a class="header-anchor" href="#obtener-cuentas-de-ahorro-saldo-contable"><span>Obtener Cuentas de Ahorro (Saldo Contable)</span></a></h1>
<p>Método para obtener las cuentas de ahorro de un cliente, junto con el saldo contable de cada una.</p>
<table>
<thead>
<tr>
...
<tbody>
<tr>
<td>BTClientes.ObtenerCuentasAhorro</td>
<td>RBTPG006</td>
<td>Global</td>
</tr>
</tbody>
...
<blockquote>
<p>Ejemplo de invocación al método Obtener Cuentas de Ahorro (Saldo Contable):</p>
</blockquote>
<code-group> 
...
<td>Listado de cajas de ahorro.</td>
</tr>
</tbody>
</table>
