<template><div><h1 id="traspasar-entre-cuentas-mismo-titular-con-tipo-de-cambio" tabindex="-1"><a class="header-anchor" href="#traspasar-entre-cuentas-mismo-titular-con-tipo-de-cambio"><span>Traspasar Entre Cuentas Mismo Titular (con tipo de cambio)</span></a></h1>
<p>Método para registrar en el sistema un traspaso entre cuentas del mismo titular.</p>
<table>
<thead>
<tr>
...
<tbody>
<tr>
<td>BTCuentasVista.TraspasarMismoTitularConCotizacion</td>
<td>RBTPG273</td>
<td>Global</td>
</tr>
</tbody>
...
<blockquote>
<p>Ejemplo de invocación al método Traspasar Entre Cuentas Mismo Titular (con tipo de cambio):</p>
</blockquote>
<code-group> 
