<template><div><h1 id="obtener-proxima-fecha-habil-de-sucursal" tabindex="-1"><a class="header-anchor" href="#obtener-proxima-fecha-habil-de-sucursal"><span>Obtener Próxima Fecha Hábil de Sucursal</span></a></h1>
<p>Método que devuelve la próxima fecha hábil a la fecha ingresada, para la sucursal recibida por parámetro.</p>
<table>
<thead>
<tr>
...
<tbody>
<tr>
<td>BTCalendario.ObtenerProximaFechaHabilSucursal</td>
<td>RBTPG333</td>
<td>Global</td>
</tr>
</tbody>
...
<blockquote>
<p>Ejemplo de invocación al método Obtener Próxima Fecha Hábil de Sucursal:</p>
</blockquote>
<code-group> 
...
<td>sentido</td>
<td>String</td>
<td>[Hidden, valor fijo 'A' para este método].</td>
</tr>
</tbody>
</table>
