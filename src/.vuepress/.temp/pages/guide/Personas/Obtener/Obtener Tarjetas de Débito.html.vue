<template><div><h1 id="obtener-tarjetas-de-debito" tabindex="-1"><a class="header-anchor" href="#obtener-tarjetas-de-debito"><span>Obtener Tarjetas de Débito</span></a></h1>
<p>Método para obtener las tarjetas de débito de una persona.</p>
<table>
<thead>
<tr>
...
<tbody>
<tr>
<td>BTPersonas.ObtenerTarjetasDeDebito</td>
<td>RBTPG383</td>
<td>Global</td>
</tr>
</tbody>
...
<blockquote>
<p>Ejemplo de invocación al servicio de Obtener Tarjetas de Débito:</p>
</blockquote>
<code-group> 
...
<tr>
<td>sdtTarjetas</td>
<td>sBDProductoTarjeta</td>
<td>Listado de tarjetas de débito.</td>
</tr>
</tbody>
</table>
<p>Los campos del tipo de dato estructurado sBDProductoTarjeta son los siguientes:</p>
<table>
<thead>
<tr>
<th>Nombre</th>
...
<td>tarjetaUId</td>
<td>Long</td>
<td>Identificador único de tarjeta de débito.</td>
</tr>
<tr>
<td>numeroTarjeta</td>
<td>String</td>
...
<tr>
<td>30002</td>
<td>No se recuperó la persona para el identificador: [Número de identificador].</td>
</tr>
</tbody>
</table>
</div></template>
