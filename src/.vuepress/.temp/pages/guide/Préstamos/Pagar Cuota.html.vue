<template><div><h1 id="pagar-cuota" tabindex="-1"><a class="header-anchor" href="#pagar-cuota"><span>Pagar Cuota</span></a></h1>
<p>Método para realizar el pago de cuota de un préstamo.</p>
<table>
<thead>
<tr>
...
<blockquote>
<p>Ejemplo de invocación al método Pagar Cuota:</p>
</blockquote>
<code-group> 
...
<tr>
<td>30007</td>
<td>No se recuperó la operación para el Identificador de Cliente: [Número de Identificador].</td>
</tr>
<tr>
<td>30008</td>
