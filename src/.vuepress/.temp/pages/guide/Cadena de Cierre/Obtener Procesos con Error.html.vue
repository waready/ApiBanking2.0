<template><div><h1 id="obtener-procesos-con-error" tabindex="-1"><a class="header-anchor" href="#obtener-procesos-con-error"><span>Obtener Procesos con Error</span></a></h1>
<p>Método para obtener un listado de los procesos con error de la cadena de cierre a una fecha dada.</p>
<table>
<thead>
<tr>
...
<tbody>
<tr>
<td>BTCadenaCierre.ObtenerProcesosConError</td>
<td>RBTPG505</td>
<td>Global</td>
</tr>
</tbody>
...
<blockquote>
<p>Ejemplo de invocación al método Obtener Procesos con Error:</p>
</blockquote>
<code-group> 
...
<tbody>
<tr>
<td>sdtProcesosBatch</td>
<td>sBTProcesoBatch</td>
<td>Colección de procesos de cadena de cierre.</td>
</tr>
</tbody>
</table>
<p>Los campos del tipo de dato estructurado sBTProcesoBatch son los siguientes:</p>
<table>
<thead>
<tr>
<th>Nombre</th>
...
<td>identificador</td>
<td>Int</td>
<td>Identificador de proceso batch.</td>
</tr>
<tr>
<td>nombre</td>
<td>String</td>
...
<tr>
<td>parametrosExtendidos</td>
<td>String</td>
<td>¿Utiliza parámetros extendidos? (SI / NO)</td>
</tr>
<tr>
<td>esReprocesable</td>
<td>String</td>
<td>Descripción para reprocesamiento.</td>
</tr>
</tbody>
</table>
