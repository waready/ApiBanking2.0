<template><div><h1 id="simular-despejando-fecha-de-vencimiento-y-tasa" tabindex="-1"><a class="header-anchor" href="#simular-despejando-fecha-de-vencimiento-y-tasa"><span>Simular Despejando Fecha de Vencimiento y Tasa</span></a></h1>
<p>Método para simular un préstamo despejando fecha de vencimiento y tasa.</p>
<table>
<thead>
<tr>
...
<tbody>
<tr>
<td>BTPrestamos.SimularDespejandoFechaVtoTasa</td>
<td>RBTPG322</td>
<td>Global</td>
</tr>
</tbody>
...
<blockquote>
<p>Ejemplo de invocación al método Simular Despejando Fecha de Vencimiento y Tasa:</p>
</blockquote>
<code-group> 
