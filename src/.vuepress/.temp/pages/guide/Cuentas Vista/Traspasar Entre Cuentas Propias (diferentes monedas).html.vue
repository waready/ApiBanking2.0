<template><div><h1 id="traspasar-entre-cuentas-propias-diferentes-monedas" tabindex="-1"><a class="header-anchor" href="#traspasar-entre-cuentas-propias-diferentes-monedas"><span>Traspasar Entre Cuentas Propias (diferentes monedas)</span></a></h1>
...
<tbody>
<tr>
<td>BTCuentasVista.TraspasarCuentasPropiasDiferentesMonedas</td>
<td>RBTPG261</td>
<td>Global</td>
</tr>
</tbody>
...
<blockquote>
<p>Ejemplo de invocación al método Traspasar Entre Cuentas Propias (diferentes monedas):</p>
</blockquote>
<code-group> 
