<template><div><h1 id="autenticacion" tabindex="-1"><a class="header-anchor" href="#autenticacion"><span>Autenticación</span></a></h1>
<p>Para poder utilizar los servicios es necesario autenticarse a efectos de obtener el SessionToken.</p>
<p>Ejemplo de invocación al método de autenticación:</p>
<code-group>
