<template><div><h1 id="contratar-ampliacion" tabindex="-1"><a class="header-anchor" href="#contratar-ampliacion"><span>Contratar Ampliación</span></a></h1>
<p>Método para dar alta de un préstamo ampliado, cancelando las operaciones indicadas en la simulación.</p>
<table>
<thead>
<tr>
...
<tbody>
<tr>
<td>BTPrestamos.ContratarAmpliacion</td>
<td>RBTPG235</td>
<td>Global</td>
</tr>
</tbody>
...
<blockquote>
<p>Ejemplo de invocación al método Contratar Ampliación:</p>
</blockquote>
<code-group> 
...
<td>ampliacionId</td>
<td>Long</td>
<td>Identificador de la ampliación simulada.</td>
</tr>
<tr>
<td>clienteUId</td>
<td>Long</td>
...
<td>accion</td>
<td>String</td>
<td>[Hidden: Valor fijo 'AMPLI' para este método].</td>
</tr>
<tr>
<td>operacionUId_desembolso</td>
<td>Long</td>
<td>Identificador único de operación de la cuenta vista donde se acreditará el monto solicitado.</td>
</tr>
<tr>
...
<tr>
<td>30001</td>
<td>No se recibió el identificador de ampliación.</td>
</tr>
<tr>
<td>30002</td>
<td>El identificador de ampliación no es válido.</td>
</tr>
<tr>
<td>30003</td>
