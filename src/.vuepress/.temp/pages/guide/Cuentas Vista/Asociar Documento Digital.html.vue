<template><div><h1 id="asociar-documento-digital" tabindex="-1"><a class="header-anchor" href="#asociar-documento-digital"><span>Asociar Documento Digital</span></a></h1>
<p>Método para asociar documento digital a la operación recibida.</p>
<table>
<thead>
<tr>
...
<tbody>
<tr>
<td>BTCuentasVista.AsociarDocumentoDigital</td>
<td>RBTPG202</td>
<td>Global</td>
</tr>
</tbody>
...
<ol>
<li>Se puede parametrizar la opción general por módulo 1416. En caso de estar en 'S', se inhabilitará el control de existencia de la operación en la tabla FSD011.</li>
</ol>
<blockquote>
<p>Ejemplo de invocación al método Asociar Documento Digital:</p>
</blockquote>
<code-group> 
...
<td>Long</td>
<td>Identificador del tipo de documento digital.</td>
</tr>
<tr>
<td>nombre</td>
<td>String</td>
...
<tr>
<td>archivoCodificado</td>
<td>String</td>
<td>Archivo a asociar codificado en Base 64.</td>
</tr>
<tr>
<td>fechaEmision</td>
<td>Date</td>
<td>Fecha de emisión del documento (en caso que corresponda).</td>
</tr>
<tr>
...
<td>documentoId</td>
<td>Long</td>
<td>Identificador del documento asociado.</td>
</tr>
</tbody>
</table>
...
<tr>
<td>30001</td>
<td>No se recibió el identificador de tipo de documento digital.</td>
</tr>
<tr>
<td>30002</td>
<td>No se recibió nombre.</td>
</tr>
<tr>
<td>30003</td>
<td>No se recibió el identificador de la operación.</td>
</tr>
<tr>
<td>30004</td>
<td>No se recibió archivo codificado.</td>
</tr>
<tr>
<td>30021</td>
<td>No se recupero el identificador para la operación recibida.</td>
</tr>
<tr>
<td>30051</td>
<td>Debe ingresar la fecha de emisión del documento.</td>
</tr>
<tr>
<td>30052</td>
<td>Debe ingresar la fecha de vencimiento del documento.</td>
</tr>
<tr>
<td>30531</td>
<td>Ya existe el tipo de documento asociado a la Operación.</td>
</tr>
<tr>
<td>31030</td>
<td>Ocurrio un error al recibir el archivo, puede que el mismo este corrupto.</td>
</tr>
<tr>
<td>31023</td>
<td>Error de configuración: El vínculo de un tipo de documento digital no puede estar vacío.</td>
</tr>
<tr>
<td>31024</td>
<td>Error de configuración: El vínculo de un tipo de documento digital no puede ser distinto al de la entidad invocadora.</td>
</tr>
</tbody>
</table>
</div></template>
