<template><div><h1 id="obtener-resumen-de-productos-saldos-disponibles" tabindex="-1"><a class="header-anchor" href="#obtener-resumen-de-productos-saldos-disponibles"><span>Obtener Resumen de Productos (Saldos Disponibles)</span></a></h1>
<p>Método para obtener un resumen de productos de un cliente, junto con el saldo disponible de cada una.</p>
<table>
<thead>
<tr>
...
<tbody>
<tr>
<td>BTClientes.ObtenerResumenProductosSD</td>
<td>RBTPG082</td>
<td>Global</td>
</tr>
</tbody>
...
<blockquote>
<p>Ejemplo de invocación al método Obtener Resumen de Productos (Saldos Disponibles):</p>
</blockquote>
<code-group> 
...
<tbody>
<tr>
<td>sdtResumenProductos</td>
<td>sCTInfoProductos</td>
<td>Listado de productos.</td>
</tr>
</tbody>
</table>
<p>Los campos del tipo de dato estructurado sCTInfoProductos son los siguientes:</p>
<table>
<thead>
<tr>
<th>Campo</th>
...
<tbody>
<tr>
<td>cuentasCorrientes</td>
<td>sCTResumenProducto</td>
...
<tr>
<td>cofresSeguridad</td>
<td>sCTResumenProducto</td>
<td>Cofres de seguridad.</td>
</tr>
<tr>
<td>tarjetasDebito</td>
<td>sCTResumenProducto</td>
...
<p>Los campos del tipo de dato estructurado sCTResumenProducto son los siguientes:</p>
<table>
<thead>
<tr>
<th>Campo</th>
...
<td>saldoUSD</td>
<td>Double</td>
<td>Saldo disponible en dólares.</td>
</tr>
<tr>
<td>saldoMN</td>
<td>Double</td>
<td>Saldo disponible en moneda nacional.</td>
</tr>
</tbody>
</table>
