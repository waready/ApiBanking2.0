<template><div><h1 id="cancelar-a-fecha-terceros" tabindex="-1"><a class="header-anchor" href="#cancelar-a-fecha-terceros"><span>Cancelar a Fecha Terceros</span></a></h1>
<p>Método para realizar la cancelación de un préstamo a terceros, a una fecha valor dada.</p>
<table>
<thead>
<tr>
...
<tbody>
<tr>
<td>BTPrestamos.CancelarAFechaTerceros</td>
<td>RBTPG833</td>
<td>Global</td>
</tr>
</tbody>
...
<ol>
<li>
<p>Definir la transacción de Pago, teniendo en cuenta que:</p>
<ul>
<li>
<p>El préstamo se almacena en el preformato 1.</p>
</li>
<li>
<p>La cuenta vista de cobro se almacena en el preformato 2.</p>
</li>
<li>
...
<li>
<p>Se debe indicar los ordinales donde se encuentra definido el préstamo y la cuenta de cobro.</p>
</li>
</ol>
<blockquote>
<p>Ejemplo de invocación al método Cancelar a Fecha Terceros:</p>
</blockquote>
<code-group> 
...
<td>operacionUId</td>
<td>Long</td>
<td>Identificador único de operación simulada.</td>
</tr>
<tr>
<td>clienteUId</td>
<td>Long</td>
...
<tr>
<td>operacionCobroUId</td>
<td>Long</td>
<td>Identificador único de operación de la cuenta vista donde se cobrará el préstamo.</td>
</tr>
<tr>
<td>referencia</td>
<td>String</td>
...
<td>fecha</td>
<td>Date</td>
<td>Fecha valor de la cancelación.</td>
</tr>
<tr>
<td>controlaExistenciaOperacionCobro</td>
<td>String</td>
<td>Indica si se controla la existencia de la operación de cobro [Hidden: Valores 'S'/'N'].</td>
</tr>
</tbody>
</table>
...
<td>movimientoUId</td>
<td>Long</td>
<td>Identificador único del movimiento.</td>
</tr>
</tbody>
</table>
...
<tr>
<td>30001</td>
<td>No se recibió el identificador de operación de préstamo.</td>
</tr>
<tr>
<td>30002</td>
<td>No se recibió el identificador de operación de cobro.</td>
</tr>
<tr>
<td>30004</td>
<td>No se recuperó la operacion para el Identificador: [Número de Identificador].</td>
</tr>
<tr>
<td>30005</td>
...
<tr>
<td>30100</td>
<td>Error en la contabilización.</td>
</tr>
<tr>
<td>40001</td>
