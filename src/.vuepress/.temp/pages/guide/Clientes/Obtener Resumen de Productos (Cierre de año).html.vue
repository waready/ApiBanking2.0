<template><div><h1 id="obtener-resumen-de-productos-cierre-de-ano" tabindex="-1"><a class="header-anchor" href="#obtener-resumen-de-productos-cierre-de-ano"><span>Obtener Resumen de Productos (Cierre de año)</span></a></h1>
<p>Método para obtener un resumen de productos de un cliente al cierre del año.</p>
<table>
<thead>
<tr>
...
<tbody>
<tr>
<td>BTClientes.ObtenerResumenProductosACierreAnio</td>
<td>RBTPG257</td>
<td>Global</td>
</tr>
</tbody>
...
<blockquote>
<p>Ejemplo de invocación al método Obtener Resumen de Productos (Cierre de año):</p>
</blockquote>
<code-group> 
