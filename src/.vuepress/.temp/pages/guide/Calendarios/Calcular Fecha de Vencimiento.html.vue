<template><div><h1 id="calcular-fecha-de-vencimiento" tabindex="-1"><a class="header-anchor" href="#calcular-fecha-de-vencimiento"><span>Calcular Fecha de Vencimiento</span></a></h1>
<p>Método que calcula la fecha de vencimiento de un plazo dada la fecha de inicio.</p>
<table>
<thead>
<tr>
...
<tbody>
<tr>
<td>BTCalendarios.CalcularFechaVencimiento</td>
<td>RBTPG340</td>
<td>Global</td>
</tr>
</tbody>
...
<blockquote>
<p>Ejemplo de invocación al método Calcular Fecha de Vencimiento:</p>
</blockquote>
<code-group> 
...
<td>fechaInicio</td>
<td>Date</td>
<td>Fecha de inicio del plazo.</td>
</tr>
<tr>
<td>plazo</td>
<td>Int</td>
...
<td>tipoDia</td>
<td>Byte</td>
<td>[Hidden, valor fijo 1 para este método].</td>
</tr>
<tr>
<td>tipoVencimiento</td>
<td>String</td>
<td>Tipo de ajuste al vencimiento ('A': Hábil anterior, 'P': Hábil posterior, 'N': No ajusta).</td>
</tr>
</tbody>
</table>
...
<td>Date</td>
<td>Fecha de vencimiento del plazo.</td>
</tr>
</tbody>
</table>
